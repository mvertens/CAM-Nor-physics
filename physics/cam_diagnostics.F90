...
!==============================================================================
  ...
  subroutine diag_init_dry(pbuf2d)
    ...
    use oslo_aero_share,    only: nbmodes, use_oslo_aero
    ...
    if (.not.dycore_is('EUL')) then
      ...
      call addfld ('PTTEND_DME', (/ 'lev' /), 'A', 'K/s ',    'T-tendency due to dry mass adjustment at the end of tphysac')
      call addfld ('IETEND_DME',  horiz_only, 'A','W/m2 ',    'Column DSE tendency due to mass adjustment at end of tphysac')
      call addfld ('EFLX    '  ,  horiz_only, 'A','W/m2 ',    'Material enthalpy flux due to mass adjustment at end of tphysac')
    end if
